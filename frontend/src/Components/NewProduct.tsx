...
function NewProduct() {
	...
	const createNewProduct = async () => {
		const product = {title: newTitle, category_id: categoryId, subcategory_id: subcategoryId, postal_code: newPostalCode, city: newCity, description: newDescription, price: newPrice}
